...
=end
@dw.test_runner.test_dlls = ['..\..\..\..\..\Temp\UnityVS_bin\Debug\Assembly-CSharp-Editor.dll']
...
#everything after this is specwatchr specific, feel free to dig into this, the source code for specwatchr is located in watcher_unity.rb
def handle filename
